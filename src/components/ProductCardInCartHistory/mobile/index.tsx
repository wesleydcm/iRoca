...
const ProductCardInCartHistoryMobile = ({
  ...
  const controller = initController();
	...
	const handleSubmit = async (feedback: IEvaluation[]): void => {
		console.log("feedback :>> ", feedback);

// TODO logica para verificar se o array de avaliações contentém duas avaliações.


		// TODO 2 req 1 p produto outra para produtor.
